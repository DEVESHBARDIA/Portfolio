  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      <div className= 'sm:px-16 px-6 absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5 mt-[-25px]'>
        ...
        <div>
          <h1 className='font-black text-white lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2 text-white'>Hi, I'm <span className='text-[#915eff]'>Devesh</span></h1>
          <p className='text-[#dfd9ff] font-medium lg:text-[25px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px] mt-1 text-white-100'>
            I am a Fullstack developer, <br className='sm:block hidden'/> creating web apps and currently focusing on Exploring myself!
          </p>
        </div>
      </div>
        <ComputersCanvas />
